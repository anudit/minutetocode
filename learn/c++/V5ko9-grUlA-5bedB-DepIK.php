...
<head>
  ...
  <script>
      ...
      window.onfocus = function () { document.title = 'C++ | 20 Minutes'; }
    </script>
  <style type="text/css">
  button{
...
<body>
  ...
  <ul class="seq-canvas">
    ...
    <li class="step5">
      <div class="box" data-seq>
        <p class="large"><b>Accessing the Data Members</b></p>
        <br>
		  <p>The public data members of objects of a class can be accessed using the direct member access operator (.).</p>
		  <br />
      <p class="code">
        Box1.height = 5.0;<br />
        Box1.length = 6.0;<br />
    ...
    <li class="step6">
      <div class="box" data-seq>
        <p class="large"><b>Member Functions</b></p>
        <br>
    ...
    <li class="step7">
      <div class="box" data-seq>
        <p class="large"><b>Member Functions</b></p>
        <br>
		  <p>Let us take previously defined class to access the members of the class using a member function instead of directly accessing them:</p>
		  <br />
      <p class="code">
        class Box {
        &nbsp;&nbsp;public:<br />
