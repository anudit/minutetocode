...
<body>
  ...
  <ul class="seq-canvas">
    ...
    <li class="step6">
      <div class="box" data-seq>
        <p class="large"><b>Data Types</b></p>
        <br />
      <p>
        <b>String</b><br />
        Contain Text and characters. Example of a String Data Type: This line is an example of a string<br />
        <br /><b>Integer</b><br />
        Non-floating-point numbers from -32,768 to 32,767. Examples of an Integer Data Type:  67, -34, -100, 203, 1022, -1, 0<br />
        <br /><b>Long</b><br />
        Non-floating-point numbers from -2,147,483,648 to 2,147,483,647. Examples of a Long Data Type: 560005, 3, -2, 0, -867000, 14, 8, -10.<br />
      </p>
      </div>
    </li>
    ...
    <li class="step7">
      ...
      <p>
        <b>Single</b><br />
        Floating-point numbers from -3.37x10^38 to 3.37x10^38. Examples of a Single Data Type: 4.3, 25.4567, -35.87, 0.35, -3.14.<br />
        <br /><b>Double</b><br />
        Floating-point numbers from -1.67x10^308 to 1.67x10^308. Examples of a Double Data Type: 745663.90596, -98.12, 4859903.094491<br />
        <br /><b>Note:</b><br />
        In QBasic 1.1 The Double may not work properly on some computers.<br />
      </p>
      </div>
    </li>
